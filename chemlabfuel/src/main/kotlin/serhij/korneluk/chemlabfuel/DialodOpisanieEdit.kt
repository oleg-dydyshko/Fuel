    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        activity?.let { activity ->
            ...
            binding.button7.setOnClickListener {
                ...
                val data = DialogData.getInstance(c.timeInMillis, 7, binding.textView7.text.toString())
            ...
            binding.button9.setOnClickListener {
                ...
                val data = DialogData.getInstance(c.timeInMillis, 9, binding.textView9.text.toString())
                data.show(childFragmentManager, "data")
            }
            binding.button10.setOnClickListener {
                ...
                val data = DialogData.getInstance(c.timeInMillis, 10, binding.textView10.text.toString())
                data.show(childFragmentManager, "data")
            }
